...
PAGE 1 : 
   ...
   RAML5      : origin = 0x00F000, length = 0x000800
   RAML6      : origin = 0x00F800, length = 0x000400
   RAML7      : origin = 0x00FC00, length = 0x000400
   /****************************/

   //RAMH       : origin = 0x00C000, length = 0x004000
   //ZONE7B     : origin = 0x20FC00, length = 0x000400     /* XINTF zone 7 - data space */
   ZONE7B     : origin = 0x280000, length = 0x000400

   //ZONE6B     : origin = 0x10FC00, length = 0x000400     /* XINTF zone 6 - data space */
   //ZONE6B     : origin = 0x180000, length = 0x000400
}
